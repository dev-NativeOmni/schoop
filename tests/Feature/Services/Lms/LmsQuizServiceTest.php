...
class LmsQuizServiceTest extends TestCase
{
    ...
    public function test_start_attempt_successfully()
    {
    ...
    public function test_start_attempt_throws_exception_if_max_attempts_reached()
    {
        $course = LmsCourse::create([
            'school_id' => $this->school->id,
            'title' => 'Test Course',
        ...
        // Second attempt should throw RuntimeException
    ...
    public function test_start_attempt_unlimited_attempts()
    {
        $course = LmsCourse::create([
            'school_id' => $this->school->id,
            'title' => 'Test Course',
