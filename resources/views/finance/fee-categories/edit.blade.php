...
<div class="max-w-4xl mx-auto px-4 py-6">
    <h1 class="text-2xl font-bold text-gray-900 mb-6">Edit Kategori Biaya</h1>
    ...
    <form action="{{ route('finance.fee-categories.update', $feeCategory) }}" method="POST" class="bg-white rounded-xl shadow p-6 space-y-5">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            <textarea name="description"
                      rows="3"
                      class="mt-1 w-full rounded-lg border-gray-300">{{ old('description', $feeCategory->description) }}</textarea>
        </div>
