...
@section('title', 'Tambah Aktivitas Mutabaah')
...
<div class="container py-4" style="max-width:720px">
    ...
    <div class="d-flex align-items-center mb-4 gap-2">
        ...
        <h1 class="h4 mb-0 fw-bold">Tambah Aktivitas Mutabaah</h1>
    </div>

    <div class="card shadow-sm">
        <div class="card-body p-4">
            <form method="POST" action="{{ route('mutabaah.activities.store') }}" id="form-activity">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <select name="mutabaah_category_id" id="mutabaah_category_id" class="form-select @error('mutabaah_category_id') is-invalid @enderror">
                        ...
                        <option value="{{ $cat->id }}" @selected(old('mutabaah_category_id') == $cat->id)>{{ $cat->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}"
                           ...
                           placeholder="Contoh: Shalat Subuh" required>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="description" id="description" rows="2"
                              ...
                              placeholder="Keterangan singkat aktivitas...">{{ old('description') }}</textarea>
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-6 col-md-3">
                            <input type="radio" class="btn-check" name="input_type" id="type_{{ $type }}" value="{{ $type }}"
                                   @checked(old('input_type','checklist') === $type) required>
                ...
                <div id="section-score" class="mb-3 d-none">
                    ...
                    <input type="number" name="target_score" id="target_score" min="0" max="100"
                           value="{{ old('target_score') }}" class="form-control" placeholder="Contoh: 80">
                </div>
                    ...
                    <div class="row g-2">
                        <div class="col-6">
                            ...
                            <input type="number" name="target_count" id="target_count" min="0"
                                   value="{{ old('target_count') }}" class="form-control" placeholder="Contoh: 1">
                        </div>
                        <div class="col-6">
                            <label for="target_unit" class="form-label fw-semibold">Satuan</label>
                            <input type="text" name="target_unit" id="target_unit"
                                   value="{{ old('target_unit') }}" class="form-control" placeholder="halaman / kali">
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="sort_order" id="sort_order" min="0" max="65535"
                           value="{{ old('sort_order', 0) }}" class="form-control" style="max-width:120px">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="form-check mb-1">
                        <input class="form-check-input" type="checkbox" name="is_required" id="is_required" value="1" @checked(old('is_required'))>
                    ...
                    <div class="form-check mb-1">
                        <input class="form-check-input" type="checkbox" name="allow_teacher_input" id="allow_teacher_input" value="1" @checked(old('allow_teacher_input', true))>
                        <label class="form-check-label" for="allow_teacher_input">Guru boleh input</label>
                    </div>
                    <div class="form-check mb-1">
                        <input class="form-check-input" type="checkbox" name="allow_parent_input" id="allow_parent_input" value="1" @checked(old('allow_parent_input'))>
                        <label class="form-check-label" for="allow_parent_input">Orang tua boleh input</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="allow_student_input" id="allow_student_input" value="1" @checked(old('allow_student_input'))>
