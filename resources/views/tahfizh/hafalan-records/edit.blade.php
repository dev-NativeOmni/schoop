...
<div class="space-y-6 max-w-4xl mx-auto">
    ...
    <div class="flex items-center space-x-3 border-b border-slate-200/80 pb-5 dark:border-slate-800">
        ...
        <div>
            <h2 class="text-2xl font-extrabold tracking-tight text-slate-900 dark:text-white">Edit Setoran Tahfizh</h2>
            <p class="text-sm text-slate-500 dark:text-slate-400">Perbarui data setoran hafalan santri.</p>
        </div>
    </div>
