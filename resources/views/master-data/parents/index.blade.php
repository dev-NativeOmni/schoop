...
<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between border-b border-slate-200/80 pb-5 dark:border-slate-800 gap-4">
        <div class="flex items-center space-x-3">
            ...
            <div>
                <h2 class="text-2xl font-extrabold tracking-tight text-slate-900 dark:text-white">Data Orang Tua</h2>
                <p class="text-sm text-slate-500 dark:text-slate-400">Kelola data orang tua atau wali murid/santri.</p>
            </div>
        </div>
        <div>
            ...
            <table class="w-full text-left border-collapse text-sm">
                <thead>
                    <tr class="bg-slate-50/40 dark:bg-slate-850/40 border-b border-slate-200/80 dark:border-slate-800">
                        <th class="px-6 py-4 text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400">Nama Orang Tua</th>
                        <th class="px-6 py-4 text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400">Hubungan</th>
                        <th class="px-6 py-4 text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400">Pekerjaan</th>
                        <th class="px-6 py-4 text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400">Daftar Anak</th>
                ...
                <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                        ...
                        <tr class="hover:bg-slate-50/40 dark:hover:bg-slate-850/10 transition-all">
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="inline-flex items-center space-x-1.5">
                                    {{-- Detail --}}
                                    <a href="{{ route('master-data.parents.show', $parent) }}" 
                                    ...
                                    {{-- Edit --}}
                                    <a href="{{ route('master-data.parents.edit', $parent) }}" 
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-8 text-center text-sm text-slate-450 dark:text-slate-500">Belum ada data orang tua terdaftar.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
