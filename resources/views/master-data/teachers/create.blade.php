...
@section('content')
    <div class="mb-6">
        <h2 class="text-2xl font-bold">Tambah Guru Tahfidz</h2>
        <p class="text-sm text-slate-500">Buat akun guru tahfidz baru.</p>
    </div>
            ...
            <div class="border-t border-slate-100 pt-4">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="employee_number" value="{{ old('employee_number') }}" class="w-full rounded-lg border border-slate-300 px-4 py-2">
                    ...
                    <div>
                        ...
                        <input type="text" name="specialization" value="{{ old('specialization', 'Tahfidz') }}" class="w-full rounded-lg border border-slate-300 px-4 py-2">
                    ...
                    <div>
                        ...
                        <input type="date" name="joined_at" value="{{ old('joined_at', now()->toDateString()) }}" class="w-full rounded-lg border border-slate-300 px-4 py-2">
