...
<div class="container-fluid py-4">
    ...
    <div class="mb-4">
        <h1 class="h3 mb-1 fw-bold text-dark">
            <i class="bi bi-journal-check text-primary me-2"></i>Mutabaah Saya
        </h1>
        <p class="text-muted mb-0">Lihat aktivitas ibadah dan karakter harian Anda.</p>
    </div>
    ...
    @if(isset($student))
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body py-3">
                <form method="GET" action="{{ route('portal.student.mutabaah') }}" class="row g-2 align-items-end">
                    <div class="col-md-3">
    ...
    @else
        <div class="text-center py-5 text-muted">
            ...
            <p class="mt-2">Profil santri belum terhubung. Hubungi admin sekolah.</p>
        </div>
    @endif
