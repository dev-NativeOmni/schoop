...
<div class="space-y-6">
    ...
    {{-- Back Link & Header --}}
    <div class="space-y-3">
        <a href="{{ route('reports.tahfizh.quarterly.index', ['year' => $year, 'quarter' => $quarter]) }}" class="inline-flex items-center space-x-1.5 text-xs font-bold text-slate-500 hover:text-slate-800 dark:text-slate-400 dark:hover:text-slate-200 transition-all">
            <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                <path stroke-linecap="round" stroke-linejoin="round" d="M15 19l-7-7 7-7" />
            </svg>
            <span>Kembali ke Laporan Triwulan</span>
        </a>
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between border-b border-slate-200/80 pb-5 dark:border-slate-800 gap-4">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    <h2 class="text-2xl font-extrabold tracking-tight text-slate-900 dark:text-white">Detail Laporan Triwulan</h2>
        ...
        <div class="lg:col-span-2">
            <div class="rounded-2xl border border-slate-200/80 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900 overflow-hidden">
                <div class="p-5 border-b border-slate-100 dark:border-slate-800/60">
                    <h3 class="text-sm font-bold text-slate-700 dark:text-slate-350 uppercase tracking-wider">Riwayat Setoran Triwulan Ini</h3>
                </div>
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse text-sm">
                        ...
                        <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="px-6 py-8 text-center text-sm text-slate-450 dark:text-slate-500">Belum ada setoran pada triwulan ini.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
