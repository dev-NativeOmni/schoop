        ...
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center space-x-6">
                ...
                <div class="hidden lg:flex items-center space-x-0.5 text-xs font-semibold">
                    ...
                    <a href="{{ route('dashboard') }}" class="flex flex-col items-center justify-center w-20 py-1.5 group transition-all rounded-xl focus:outline-none">
                        @if ($active)
                            ...
                            <span class="text-[9px] tracking-wide font-black text-[#A3E635] mt-1">Dashboard</span>
                        @else
                            ...
                            <span class="text-[9px] tracking-wide text-slate-400 group-hover:text-white mt-1 transition-colors">Dashboard</span>
                        @endif
                    </a>
                    ...
                    @if ($canViewSchoolOs)
                        ...
                        <div class="relative" @click.outside="openDropdown === 'schoolos' && (openDropdown = null)">
                            <button @click="openDropdown = openDropdown === 'schoolos' ? null : 'schoolos'" class="flex flex-col items-center justify-center w-20 py-1.5 group transition-all rounded-xl focus:outline-none">
                                @if ($active)
                                    ...
                                    <span class="text-[9px] tracking-wide font-black text-[#A3E635] mt-1 flex items-center justify-center gap-0.5 w-full">SchoolOS <svg class="h-2.5 w-2.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M19 9l-7 7-7-7" /></svg></span>
                                @else
                    ...
                    @if ($hasAdminOrSuperAdmin)
                        ...
                        <div class="relative" @click.outside="openDropdown === 'master' && (openDropdown = null)">
                            <button @click="openDropdown = openDropdown === 'master' ? null : 'master'" class="flex flex-col items-center justify-center w-20 py-1.5 group transition-all rounded-xl focus:outline-none">
                                @if ($active)
                                    ...
                                    <span class="text-[9px] tracking-wide font-black text-[#A3E635] mt-1 flex items-center justify-center gap-0.5 w-full">Data Master <svg class="h-2.5 w-2.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M19 9l-7 7-7-7" /></svg></span>
                                @else
                        ...
                        <div class="relative" @click.outside="openDropdown === 'tahfizh' && (openDropdown = null)">
                            <button @click="openDropdown = openDropdown === 'tahfizh' ? null : 'tahfizh'" class="flex flex-col items-center justify-center w-20 py-1.5 group transition-all rounded-lg focus:outline-none">
                                @if ($active)
                                    ...
                                    <span class="text-[9px] tracking-wide font-black text-[#A3E635] mt-1 flex items-center justify-center gap-0.5 w-full">Tahfizh <svg class="h-2.5 w-2.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M19 9l-7 7-7-7" /></svg></span>
                                @else
                        ...
                        <div class="relative" @click.outside="openDropdown === 'mutabaah' && (openDropdown = null)">
                            <button @click="openDropdown = openDropdown === 'mutabaah' ? null : 'mutabaah'" class="flex flex-col items-center justify-center w-20 py-1.5 group transition-all rounded-lg focus:outline-none">
                                @if ($active)
                                    ...
                                    <span class="text-[9px] tracking-wide font-black text-[#A3E635] mt-1 flex items-center justify-center gap-0.5 w-full">Mutabaah <svg class="h-2.5 w-2.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M19 9l-7 7-7-7" /></svg></span>
                                @else
                        ...
                        <div class="relative" @click.outside="openDropdown === 'attendance' && (openDropdown = null)">
                            <button @click="openDropdown = openDropdown === 'attendance' ? null : 'attendance'" class="flex flex-col items-center justify-center w-20 py-1.5 group transition-all rounded-lg focus:outline-none">
                                @if ($active)
                                    ...
                                    <span class="text-[9px] tracking-wide font-black text-[#A3E635] mt-1 flex items-center justify-center gap-0.5 w-full">Kehadiran <svg class="h-2.5 w-2.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M19 9l-7 7-7-7" /></svg></span>
                                @else
                        ...
                        <div class="relative" @click.outside="openDropdown === 'tahsin' && (openDropdown = null)">
                            <button @click="openDropdown = openDropdown === 'tahsin' ? null : 'tahsin'" class="flex flex-col items-center justify-center w-20 py-1.5 group transition-all rounded-lg focus:outline-none">
                                @if ($active)
                                    ...
                                    <span class="text-[9px] tracking-wide font-black text-[#A3E635] mt-1 flex items-center justify-center gap-0.5 w-full">Tahsin <svg class="h-2.5 w-2.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M19 9l-7 7-7-7" /></svg></span>
                                @else
                        ...
                        <div class="relative" @click.outside="openDropdown === 'finance' && (openDropdown = null)">
                            <button @click="openDropdown = openDropdown === 'finance' ? null : 'finance'" class="flex flex-col items-center justify-center w-20 py-1.5 group transition-all rounded-lg focus:outline-none">
                                @if ($active)
                                    ...
                                    <span class="text-[9px] tracking-wide font-black text-[#A3E635] mt-1 flex items-center justify-center gap-0.5 w-full">Keuangan <svg class="h-2.5 w-2.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M19 9l-7 7-7-7" /></svg></span>
                                @else
                        ...
                        <div class="relative" @click.outside="openDropdown === 'parent' && (openDropdown = null)">
                            <button @click="openDropdown = openDropdown === 'parent' ? null : 'parent'" class="flex flex-col items-center justify-center w-20 py-1.5 group transition-all rounded-lg focus:outline-none">
                                @if ($active)
                                    ...
                                    <span class="text-[9px] tracking-wide font-black text-[#A3E635] mt-1 flex items-center justify-center gap-0.5 w-full">Portal Wali <svg class="h-2.5 w-2.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M19 9l-7 7-7-7" /></svg></span>
                                @else
                        ...
                        <div class="relative" @click.outside="openDropdown === 'student' && (openDropdown = null)">
                            <button @click="openDropdown = openDropdown === 'student' ? null : 'student'" class="flex flex-col items-center justify-center w-20 py-1.5 group transition-all rounded-lg focus:outline-none">
                                @if ($active)
                                    ...
                                    <span class="text-[9px] tracking-wide font-black text-[#A3E635] mt-1 flex items-center justify-center gap-0.5 w-full">Portal Santri <svg class="h-2.5 w-2.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M19 9l-7 7-7-7" /></svg></span>
                                @else
