...
class KnowledgeBaseArticleController extends Controller
{
    ...
    public function index(): View { return view('saas-ops.knowledge-base.index', ['articles' => KnowledgeBaseArticle::query()->latest()->paginate(20)]); }
    public function create(): View { return view('saas-ops.knowledge-base.create', ['article' => null]); }
    ...
    public function show(KnowledgeBaseArticle $knowledgeBase): View { return view('saas-ops.knowledge-base.show', ['article' => $knowledgeBase]); }
    public function edit(KnowledgeBaseArticle $knowledgeBase): View { return view('saas-ops.knowledge-base.edit', ['article' => $knowledgeBase]); }
    ...
    public function destroy(KnowledgeBaseArticle $knowledgeBase): RedirectResponse { $knowledgeBase->update(['status' => 'draft']); return back()->with('success', 'Artikel dikembalikan ke draft.'); }
}
