...
class ReleaseNoteController extends Controller
{
    ...
    public function index(): View { return view('saas-ops.release-notes.index', ['releaseNotes' => ReleaseNote::query()->latest()->paginate(20)]); }
    public function create(): View { return view('saas-ops.release-notes.create', ['releaseNote' => null]); }
    ...
    public function show(ReleaseNote $releaseNote): View { return view('saas-ops.release-notes.show', compact('releaseNote')); }
    public function edit(ReleaseNote $releaseNote): View { return view('saas-ops.release-notes.edit', compact('releaseNote')); }
    ...
    public function destroy(ReleaseNote $releaseNote): RedirectResponse { $releaseNote->update(['status' => 'draft']); return back()->with('success', 'Release note dikembalikan ke draft.'); }
}
