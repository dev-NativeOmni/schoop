...
class SlaPolicyController extends Controller
{
    ...
    {
        return view('saas-ops.sla-policies.index', ['policies' => SlaPolicy::query()->orderBy('priority')->paginate(20)]);
    }

    public function create(): View
    {
        return view('saas-ops.sla-policies.create', ['policy' => null]);
    }
    ...
    public function show(SlaPolicy $slaPolicy): View
    {
        return view('saas-ops.sla-policies.show', ['policy' => $slaPolicy]);
    }

    public function edit(SlaPolicy $slaPolicy): View
    {
        return view('saas-ops.sla-policies.edit', ['policy' => $slaPolicy]);
    }
    ...
    public function destroy(SlaPolicy $slaPolicy): RedirectResponse
    {
        ...
        return back()->with('success', 'SLA dinonaktifkan.');
    }
}
