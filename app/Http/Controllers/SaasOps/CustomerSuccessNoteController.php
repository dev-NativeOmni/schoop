...
{
    public function index(): View { return view('saas-ops.customer-success-notes.index', ['notes' => CustomerSuccessNote::query()->with('school')->latest()->paginate(20)]); }
    public function create(): View { return view('saas-ops.customer-success-notes.create', ['schools' => School::query()->orderBy('name')->get()]); }
    ...
    public function show(CustomerSuccessNote $customerSuccessNote): View { return view('saas-ops.customer-success-notes.show', ['note' => $customerSuccessNote->load('school')]); }
}
